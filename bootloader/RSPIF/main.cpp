...
#include "SPIFBlockDevice.h"
  ...
  SPIFBlockDevice sd(MBED_CONF_SPIF_DRIVER_SPI_MOSI, MBED_CONF_SPIF_DRIVER_SPI_MISO,
                   MBED_CONF_SPIF_DRIVER_SPI_CLK,  MBED_CONF_SPIF_DRIVER_SPI_CS, MBED_CONF_SPIF_DRIVER_SPI_FREQ);  
#elif COMPONENT_RSPIF
  SPIFReducedBlockDevice  sd(MBED_CONF_RSPIF_DRIVER_SPI_MOSI, MBED_CONF_RSPIF_DRIVER_SPI_MISO,
                   MBED_CONF_RSPIF_DRIVER_SPI_CLK,  MBED_CONF_RSPIF_DRIVER_SPI_CS, MBED_CONF_RSPIF_DRIVER_SPI_FREQ);  
#endif
